\documentclass[PhD]{iitmdiss} %rename iitm to iitism, besides I cannot compile this file unless you push all the style files
...
% a logo should go somewhere here
...
\noindent IIT-DHANBAD, 826 004 \\ % it is IIT (ISM) Dhanbad officialy
} 
\hspace*{1.0in} 
%\parbox{2.5in}{
